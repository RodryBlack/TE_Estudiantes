...
public class Controlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ses.getAttribute("listaes")==null){
            ArrayList<Estudiante> listaux=new ArrayList<Estudiante>();
            ses.setAttribute("listaes", listaux);
        }
        
        ArrayList<Estudiante> lista=(ArrayList<Estudiante>) ses.getAttribute("listaes");
        ...
        switch(option){
            ...
            case "eliminar":
                ...
                pos=buscarIndice(request,id);
                lista.remove(pos);
                ses.setAttribute("listaes", lista);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            obj1.setValor(request.getParameter("valor"));
